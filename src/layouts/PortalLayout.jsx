...
const navItems = [
  ...
  { label: 'Maintenance Mode', path: '/admin-maintenance', adminOnly: true, icon: (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M2.166 4.9L10 1.154l7.834 3.746A1 1 0 0118.5 5.8v4.615a12.023 12.023 0 01-4.82 9.584l-3.327 2.456a.75.75 0 01-.706 0l-3.327-2.456A12.024 12.024 0 015.5 10.415V5.8a1 1 0 01.666-.9zM10 5a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 0110 5zm0 9a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
    </svg>
  )},
]
